    ...
    <UContainer as="footer" class="py-24">
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-32">
            <div class="mx-auto max-w-sm md:max-w-none">
                <p class="mt-4 text-center md:text-left md:text-lg">
                    Everything you need for a stress-free outing, from newborn
                    essentials to toddler <i>emergency</i> kits.
                </p>

                <div class="mt-6 flex justify-center gap-4 md:justify-start">
                    <ULink
                        class="transition hover:/75"
                        href="https://github.com/krystlc/parking-parents"
                        target="_blank"
                        rel="noreferrer"
                    >
        ...
        <div class="mt-16 border-t pt-8">
            <p class="text-center text-xs/relaxed">
                ...
                Made in Tampa, FL for
                <UIcon
                    name="i-lucide-heart"
                    class="text-rose-500 size-4 -my-1"
                />
                everybody.
            </p>
        </div>
